...
export const ROUTES: readonly Route[] = [
  {
    ...
    description:
      'Boxe, travail au sol et sports de combat à proximité de Castelginest : le 60 rejoint le métro, le 59 finit avenue des États-Unis, où Boxing Center occupe 1 200 m².',
    menu: true,
    index: true,
  },
  {
    ...
    description:
      'Cours de boxe anglaise accessibles depuis Castelginest, sur deux rings de compétition. Aucun niveau demandé, et un groupe compétiteurs amateurs.',
    menu: true,
    index: true,
  },
  {
    ...
    chemin: '/mma/',
    nav: 'Travail au sol',
    question: 'Où faire du grappling et du travail au sol quand on part de Castelginest ?',
    titre: 'Grappling et travail au sol près de Castelginest | Boxing Center',
    description:
      'Le travail au sol se pratique sur 400 m² de tatamis, avec une cage surélevée officielle et des panneaux pour le cage control. À proximité de Castelginest.',
    menu: true,
    index: true,
  },
  {
    ...
    titre: 'Boxe pieds-poings près de Castelginest | Boxing Center',
    description:
      'Boxe pieds-poings et full contact, sur deux rings de compétition et 400 m² de tapis. Accessible depuis Castelginest par le 60, le métro et le 59.',
    menu: true,
    index: true,
  },
  {
  ...
  },
  {
    ...
    description:
      'Le 60 part de Saint-Alban Centre Commercial et rejoint le métro ; le 59 finit avenue des États-Unis. Boxing Center y réunit boxe, travail au sol et prépa physique.',
    menu: false,
    index: true,
    commune: true,
  },
  {
    ...
    description:
      'Le 60 dessert Launaguet et rejoint Trois Cocus ; le métro et le 59 finissent avenue des États-Unis. Boxe, travail au sol et préparation physique sur 1 200 m².',
    menu: false,
    index: true,
    commune: true,
  },
